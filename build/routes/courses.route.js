...
coursesRouter.put('/courses/update', passport.authenticate('adminJWT', { session: false }), CoursesController.update);
coursesRouter.delete('/courses/delete', passport.authenticate('adminJWT', { session: false }), CoursesController.delete);
coursesRouter.get('/courses/deleted', passport.authenticate('adminJWT', { session: false }), CoursesController.getDeleted);
coursesRouter.put('/courses/restore', passport.authenticate('adminJWT', { session: false }), CoursesController.restore);
