...
studentsRouter.put('/students/update', passport.authenticate('userJWT', { session: false }), StudentsController.update);
studentsRouter.delete('/students/delete', passport.authenticate('userJWT', { session: false }), StudentsController.delete);
studentsRouter.get('/students/deleted', passport.authenticate('userJWT', { session: false }), StudentsController.getDeleted);
studentsRouter.put('/students/restore', passport.authenticate('userJWT', { session: false }), StudentsController.restore);
